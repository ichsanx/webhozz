...
<form class="pure-form" action="insert_Artikel.php" method="post" enctype="multipart/form-data">
<h1>Form Input Artikel</h1>
  <table width="550" border="0" cellspacing="3" cellpadding="2">
    <tr>
      ...
      <td width="9">:</td>
      <td width="330">
      <input type="text" name="judul" id="judul" placeholder="Masukkan Judul"/></td>
    </tr>
    <tr>
      <td>Deskripsi Singkat</td>
      <td>:</td>
      <td><textarea name="desk_singkat" id="desk_singkat" cols="45" rows="5"></textarea></td>
    </tr>
    <tr>
      <td>Detail Deskripsi</td>
      <td>:</td>
      <td><textarea name="detail_desk" id="detail_desk" cols="45" rows="5"></textarea></td>
    </tr>
    <tr>
      <td>Kategori</td>
      <td>:</td>
...
if(isset($_GET['status']))
	{
		...
		switch($status)
		{
			case 0:
				...
				echo "<a class='pure-button' href='file_data_Artikel.php'>
			...
			case 1:
				...
				break;
			case 2:
				echo"Upload gagal, format yang diperbolehkan hanya jpg, jpeg, gif";	
				break;
			case 3:
